...
export function App() {
    ...
    const [notarizedResponse, setnotarizedResponse] = useState<boolean | undefined>();
    const [deployTxHash, setDeployTxHash] = useState<string | undefined>();
    const [polyjuiceAddress, setPolyjuiceAddress] = useState<string | undefined>();
    const [transactionInProgress, setTransactionInProgress] = useState(false);
    const toastId = React.useRef(null);
    const [notarizedDocument,setNotarizedDocument]=useState<string | undefined >();
    ...
    async function checkDocument() {
        ...
        toast('Successfully Read The Document Notarization status.', { type: 'success' });
    ...
    async function notarize() {
        try {
            ...
            toast(
                'Successfully Notrized the document, You can Check it manually.',
                { type: 'success' }
            );
        } catch (error) {
            console.error(error);
    ...
    return (
        ...
        <div>
            <Container>
                ...
                <h2>  <b>  Nervos Notarizing Documents Decentralized App</b> </h2>
                </Alert>
            </Container>
            <Container>
                <Row>
            ...
            <Container>        
            <Alert variant={'info'} >
                The button below will deploy Notarizing Document smart contract where you can notarize a document. 
                After deploying the contract, you can store the document that you want to Notarize then after you can check if the Document is notarized or not.
            </Alert>
            </Container>
            <Container>
                <Col>
       ...
       <h2>  {notarizedResponse ? <>&nbsp;&nbsp; {notarizedResponse ? 
       <h2>The Document was Notarized</h2> :  <h2> The Document Wasn't Notarized</h2> } </> : null}</h2> 
            <br />
            <br />
            </Container>
            <br />
