...
import * as BayouStorageJSON from '../../../build/contracts/BayouStorage.json';
...
export class BayouStorageWrapper {
    web3: Web3;
    ...
    constructor(web3: Web3) {
        this.web3 = web3;
        this.contract = new web3.eth.Contract(BayouStorageJSON.abi as any) as any;
    }
